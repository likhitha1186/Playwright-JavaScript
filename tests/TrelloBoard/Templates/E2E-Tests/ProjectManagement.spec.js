...
test('select Project Management Template ', async ()=>{
    const selectTemp = new TemplatesPage(page);
    await selectTemp.ProjectManagement("Project Management");
    console.log("Successfully selected Project Management Template");
})
