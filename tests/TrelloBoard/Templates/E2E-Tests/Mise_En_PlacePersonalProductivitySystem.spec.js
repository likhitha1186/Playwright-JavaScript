...
test('select Mise-En-Place Personal Productivity System Agenda Template ', async ()=>{
    const selectTemp = new TemplatesPage(page);
    await selectTemp.Mise_En_PlacePersonalProductivitySystem("Mise-En-Place Personal Productivity System");
    console.log("Successfully selected Mise-En-Place Personal Productivity System Template");
})
